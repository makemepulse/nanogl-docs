import{C as L,P as V,N as F}from"./index-099e42fb.js";import{A as G,P as N}from"./arraybuffer-7f1df196.js";import{G as U,a as z,I as D}from"./indexbuffer-5b89fc58.js";import{cubePosUvs as H,cubeIndices as W}from"./cubeGeometry-a8671df7.js";import{c as j}from"./vec3-33249e24.js";import{c as k}from"./mat4-2d297a36.js";import"./common-a066d304.js";const ee=R=>{let m=!0;const c=R||document.getElementById("canvas"),e=c.getContext("webgl"),n={width:1,height:1},w=window.devicePixelRatio,_=([t])=>{const a=t.contentRect.width,r=t.contentRect.height;c.width=Math.round(a*w),c.height=Math.round(r*w),n.width=e.drawingBufferWidth,n.height=e.drawingBufferHeight},u=new ResizeObserver(_);u.observe(c);const d=U.get(e),y=new z().enableDepthTest().enableCullface().cullFace(e.BACK);d.push(y);const h=j(),o=new L(new V);o.lens.setAutoFov(35*(Math.PI/180)),o.lens.near=.01,o.lens.far=50,o.position.set([0,4,10]),o.lookAt(h);const f=new G(e,new Float32Array(H)),p=new D(e,e.UNSIGNED_SHORT,new Uint16Array(W));f.attrib("aPosition",3,e.FLOAT),f.attrib("aTexCoord",2,e.FLOAT);const E=`
