...
</code></pre><h2 id="add-some-movement" tabindex="-1">Add some movement</h2><p>Let’s add some movement to our shader. We will change the blue value of the color over time.</p><p>As seen in the <a href="//guide/getting-started/add-movement">Add some movement</a> article, we can pass a timestamp to the render function.</p><p>Let’s use it to set a time uniform in our shader.</p><pre class="language-js"><code class="language-js"><span class="token comment">// ...</span>
