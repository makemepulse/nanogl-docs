import{C as R,P as M}from"./index-5809b7fb.js";import{A as y,P as O}from"./arraybuffer-1b6e50fc.js";import{G as S,a as U,I as V}from"./indexbuffer-13597e9e.js";import{T as _}from"./texture-2d-18ce519d.js";import{P as D}from"./tweakpane-24b35bd6.js";import{t as E}from"./square-texture-5de1b8a4.js";import{cubePosUvs as L,cubeIndices as z}from"./cubeGeometry-a8671df7.js";import{c as G}from"./vec3-a79e08f1.js";import"./common-a066d304.js";const Q=x=>{let l=!0;const s=x||document.getElementById("canvas"),e=s.getContext("webgl"),n={width:1,height:1},v=window.devicePixelRatio,T=([a])=>{const I=a.contentRect.width,A=a.contentRect.height;s.width=Math.round(I*v),s.height=Math.round(A*v),n.width=e.drawingBufferWidth,n.height=e.drawingBufferHeight},g=new ResizeObserver(T);g.observe(s);const c=S.get(e),F=new U().enableDepthTest().enableCullface().cullFace(e.BACK);c.push(F);const w=G(),t=new R(new M);t.lens.setAutoFov(35*(Math.PI/180)),t.lens.near=.01,t.lens.far=50,t.position.set([0,4,10]),t.lookAt(w);const p=new y(e,new Float32Array(L)),m=new V(e,e.UNSIGNED_SHORT,new Uint16Array(z));p.attrib("aPosition",3,e.FLOAT),p.attrib("aTexCoord",2,e.FLOAT);const o={wrap:"repeat",uvFactorX:1,uvFactorY:1},r=new _(e);r.repeat();const u=new Image;u.src=E,u.onload=()=>{r.fromImage(u)};const P=`
