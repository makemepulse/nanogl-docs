...
</code></pre>`,8),h=s("p",null,[s("strong",null,"Note :"),t(" This is the most basic way of loading a model with nanogl-gltf, but some more complete and detailed implementations may be better suited to your project (light management, animations, adding extensions support, …). You can see one on the "),s("a",{href:"https://github.com/makemepulse/nanogl-starter",target:"_blank",rel:"noopener"},"starter"),t(".")],-1),w=a(`<h2 id="render-the-model" tabindex="-1">Render the model</h2><p>Then, to render the model, you just have to call the render function on each gltf’s renderable (they all are <a href="//api/nanogl-gltf/classes/MeshRenderer">MeshRenderer</a>).</p><p>You have to pass the GL context, the current camera, the <a href="//api/nanogl-gltf/interfaces/IRenderConfig">mask ID</a> (1 is the OPAQUE mask, the default one), and the pass ID (COLOR, DEPTH, custom other passes…).</p><pre class="language-js"><code class="language-js"><span class="token keyword">const</span> <span class="token function-variable function">render</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...</span>
...
<span class="token keyword">const</span> <span class="token function-variable function">render</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token function">requestAnimationFrame</span><span class="token punctuation">(</span>render<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre>`,3),x=a('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#loading-a-file">Loading a file</a></li><li><a href="#render-the-model">Render the model</a></li><li><a href="#add-lights">Add lights</a></li><li><a href="#add-some-movement">Add some movement</a></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div>',1),L={class:"nav-wrapper"},_={__name:"load-gltf",setup(S,{expose:l}){return l({frontmatter:{}}),(q,T)=>{const u=k,o=i,e=d("RouterLink");return r(),m("div",g,[s("div",b,[f,n(u,{type:"info"},{default:p(()=>[h]),_:1}),w,n(o,{name:"load-gltf-model",folder:"guide"}),y,n(o,{name:"load-gltf-model-lights",folder:"guide"}),v]),x,s("div",L,[n(e,{to:"/guide/getting-started/add-movement",class:"prev"},{default:p(()=>[t("Add some movement")]),_:1}),n(e,{to:"/guide/getting-started/full-screen-shader",class:"next"},{default:p(()=>[t("Full-screen shader")]),_:1})])])}}};typeof c=="function"&&c(_);export{_ as default};
