import{b as K,P,a as te,A as ne}from"./arraybuffer-7f1df196.js";import{F as re}from"./fbo-645f2652.js";import{B as oe,E as N,m as ie,a as se,F as ae}from"./fetch-f973e09f.js";import{c as j,t as A}from"./vec3-33249e24.js";import{C as ce,P as le,N as he}from"./index-099e42fb.js";import{G as ue,a as fe,I as de}from"./indexbuffer-5b89fc58.js";import{P as pe}from"./tweakpane-24b35bd6.js";import{cubePosUvs as me,cubeIndices as ve}from"./cubeGeometry-a8671df7.js";import{c as ge}from"./mat4-2d297a36.js";import"./texture-2d-53b1df66.js";import"./common-a066d304.js";let De=0;class be{constructor(e){this._uid=De++,this.gl=e,this.id=e.createSampler(),this.setFilter(!0)}bind(e){this.gl.bindSampler(e,this.id)}dispose(){this.gl.deleteSampler(this.id)}setFilter(e=!1,t=!1,r=!1){const o=this.gl;o.samplerParameteri(this.id,o.TEXTURE_MAG_FILTER,K(!!e,!1,!1)),o.samplerParameteri(this.id,o.TEXTURE_MIN_FILTER,K(!!e,!!t,!!r))}repeat(){this.wrap(this.gl.REPEAT)}clamp(){this.wrap(this.gl.CLAMP_TO_EDGE)}mirror(){this.wrap(this.gl.MIRRORED_REPEAT)}wrap(e){const t=this.gl;t.samplerParameteri(this.id,t.TEXTURE_WRAP_S,e),t.samplerParameteri(this.id,t.TEXTURE_WRAP_T,e)}}var C=function(n){var e="";return e+=`precision mediump float;
