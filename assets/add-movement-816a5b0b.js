...
<span class="token punctuation">}</span>
</code></pre><h3 id="world-matrix" tabindex="-1">World matrix</h3><p>Now we need to update the node world matrix to reflect these changes.</p>`,30),w=n("p",null,[n("strong",null,"Important :"),s(" Make sure you update the node world matrix "),n("em",null,"after"),s(" the transforms and "),n("em",null,"before"),s(" computing the model view projection matrix.")],-1),v=t(`<pre class="language-js"><code class="language-js"><span class="token keyword">const</span> <span class="token function-variable function">animate</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">time</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  <span class="token comment">// ...</span>
...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre>`,3),y=t('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#setup-render-loop">Setup render loop</a></li><li><a href="#create-the-node">Create the node</a></li><li><a href="#play-transform">Play with the transform values</a><ul><li><a href="#setup-a-function">Setup a function</a></li><li><a href="#position-%26-scale">Position &amp; scale</a></li><li><a href="#rotation">Rotation</a></li><li><a href="#world-matrix">World matrix</a></li></ul></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div>',1),x={class:"nav-wrapper"},_={__name:"add-movement",setup(j,{expose:c}){return c({frontmatter:{}}),(P,z)=>{const u=k,l=i,o=d("RouterLink");return r(),m("div",g,[n("div",f,[h,a(u,{type:"important"},{default:p(()=>[w]),_:1}),v,a(l,{name:"add-movement",folder:"guide"}),b]),y,n("div",x,[a(o,{to:"/guide/getting-started/creating-a-scene",class:"prev"},{default:p(()=>[s("Creating a scene")]),_:1}),a(o,{to:"/guide/getting-started/load-gltf",class:"next"},{default:p(()=>[s("Load a GLTF model")]),_:1})])])}}};typeof e=="function"&&e(_);export{_ as default};
