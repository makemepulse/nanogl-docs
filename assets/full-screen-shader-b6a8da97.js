import{A as b,P as p}from"./arraybuffer-1b6e50fc.js";const x=l=>{let r=!0;const t=l||document.getElementById("canvas"),e=t.getContext("webgl"),o={width:1,height:1},s=window.devicePixelRatio,h=([a])=>{const m=a.contentRect.width,f=a.contentRect.height;t.width=Math.round(m*s),t.height=Math.round(f*s),o.width=e.drawingBufferWidth,o.height=e.drawingBufferHeight},c=new ResizeObserver(h);c.observe(t);const u=new Float32Array([-1,3,0,2,-1,-1,0,0,3,-1,2,0]),i=new b(e,u);i.attrib("aPosition",2,e.FLOAT),i.attrib("aTexCoord",2,e.FLOAT);const w=`
