import{_ as u}from"./GLPreview.vue_vue_type_script_setup_true_lang-d4a6e031.js";import{_ as i}from"./UICallout.vue_vue_type_script_setup_true_lang-9ed50965.js";import{b as o}from"./route-block-83d24a4e.js";import{A as r,C as k,E as n,O as s,I as e,P as t,J as a}from"./runtime-core.esm-bundler-b2e16801.js";import"./index-3e5a32dc.js";const d={class:"markdown-body"},m={class:"content-wrapper"},h=n("h1",{id:"creating-a-scene",tabindex:"-1"},"Creating a scene",-1),g=n("p",null,"Let’s begin by creating a simple scene, rendering a triangle.",-1),w=n("p",null,[n("strong",null,"Note :"),a(" You will need to install some libraries for this guide. All the imports are specified in the code samples, so please install the packages when you see an import for a lib that you do not already have installed.")],-1),f=n("h2",{id:"setup-canvas-context",tabindex:"-1"},"Setup the canvas & context",-1),y=n("p",null,[n("strong",null,"Important :"),a(" This part is necessary for every article in the "),n("em",null,"Getting Started"),a(" guide. The code will be used as the base for all the other articles.")],-1),v=t(`<p>We can start by setting up the canvas &amp; context. This is not specific to nanogl, you can do this as you would in your usual WebGL project.</p><p>First, in a Javascript file, we need to create the canvas in which we will render our WebGL project, and get the WebGL rendering context.</p><pre class="language-js"><code class="language-js"><span class="token keyword">const</span> canvas <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;canvas&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><p>Of course, in a bigger project, it would be preferable to create functions and/or classes to better organize the code, but that is entirely up to you.</p>`,4),z=t('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#setup-canvas-context">Setup the canvas &amp; context</a></li><li><a href="#create-the-camera">Create the camera</a></li><li><a href="#create-the-shape">Create the shape</a></li><li><a href="#create-the-program">Create the program</a><ul><li><a href="#vertex-shader">Vertex shader</a></li><li><a href="#fragment-shader">Fragment shader</a></li><li><a href="#program">Program</a></li></ul></li><li><a href="#draw-the-shape">Draw the shape</a></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div><div class="nav-wrapper"><a class="prev" href="/guide/getting-started/installation">Installation</a><a class="next" href="/guide/getting-started/add-movement">Add some movement</a></div>',2),P={__name:"creating-a-scene",setup(C,{expose:c}){return c({frontmatter:{}}),(R,q)=>{const p=i,l=u;return r(),k("div",d,[n("div",m,[h,g,s(p,{type:"info"},{default:e(()=>[w]),_:1}),f,s(p,{type:"important"},{default:e(()=>[y]),_:1}),v,s(p,{type:"info"},{default:e(()=>[b]),_:1}),x,s(l,{name:"creating-a-scene",folder:"guide"}),_]),z])}}};typeof o=="function"&&o(P);export{P as default};
