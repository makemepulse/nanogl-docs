...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><p>Of course, in a bigger project, it would be preferable to create functions and/or classes to better organize the code, but that is entirely up to you.</p>`,38),y=e('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#setup-canvas-context">Setup the canvas &amp; context</a></li><li><a href="#create-the-camera">Create the camera</a></li><li><a href="#create-the-shape">Create the shape</a></li><li><a href="#create-the-program">Create the program</a><ul><li><a href="#vertex-shader">Vertex shader</a></li><li><a href="#fragment-shader">Fragment shader</a></li><li><a href="#program">Program</a></li></ul></li><li><a href="#draw-the-shape">Draw the shape</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div>',1),b={__name:"creating-a-scene",setup(v,{expose:c}){return c({frontmatter:{}}),(P,_)=>{const a=l;return u(),i("div",r,[n("div",k,[d,m,p(a,{type:"info"},{default:o(()=>[h]),_:1}),g,p(a,{type:"important"},{default:o(()=>[w]),_:1}),f]),y])}}};typeof t=="function"&&t(b);export{b as default};
