import{_ as i}from"./GLPreview.vue_vue_type_script_setup_true_lang-152ead4f.js";import{_ as r}from"./UICallout.vue_vue_type_script_setup_true_lang-9ed50965.js";import{b as c}from"./route-block-83d24a4e.js";import{A as k,C as d,E as n,O as s,I as t,P as p,z as m,J as a}from"./runtime-core.esm-bundler-b2e16801.js";import"./index-6a4a14ff.js";const h={class:"markdown-body"},g={class:"content-wrapper"},w=n("h1",{id:"creating-a-scene",tabindex:"-1"},"Creating a scene",-1),f=n("p",null,"Let’s begin by creating a simple scene, rendering a triangle.",-1),y=n("p",null,[n("strong",null,"Note :"),a(" You will need to install some libraries for this guide. All the imports are specified in the code samples, so please install the packages when you see an import for a lib that you do not already have installed.")],-1),v=n("h2",{id:"setup-canvas-context",tabindex:"-1"},"Setup the canvas & context",-1),b=n("p",null,[n("strong",null,"Important :"),a(" This part is necessary for every article in the "),n("em",null,"Getting Started"),a(" guide. The code will be used as the base for all the other articles.")],-1),x=p(`<p>We can start by setting up the canvas &amp; context. This is not specific to nanogl, you can do this as you would in your usual WebGL project.</p><p>First, in a Javascript file, we need to create the canvas in which we will render our WebGL project, and get the WebGL rendering context.</p><pre class="language-js"><code class="language-js"><span class="token keyword">const</span> canvas <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;canvas&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><p>Let’s also call the render function when the canvas is resized, to adapt the render to the new size.</p>`,35),_=n("p",null,[n("strong",null,"Note :"),a(" We will only call a render on resize here because the render is static. When the render is updated on each frame, it is not useful.")],-1),z=p(`<pre class="language-js"><code class="language-js"><span class="token comment">// ...</span>
...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><p>Of course, in a bigger project, it would be preferable to create functions and/or classes to better organize the code, but that is entirely up to you.</p>`,4),C=p('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#setup-canvas-context">Setup the canvas &amp; context</a></li><li><a href="#create-the-camera">Create the camera</a></li><li><a href="#create-the-shape">Create the shape</a></li><li><a href="#create-the-program">Create the program</a><ul><li><a href="#vertex-shader">Vertex shader</a></li><li><a href="#fragment-shader">Fragment shader</a></li><li><a href="#program">Program</a></li></ul></li><li><a href="#draw-the-shape">Draw the shape</a></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div>',1),R={class:"nav-wrapper"},j={__name:"creating-a-scene",setup(q,{expose:l}){return l({frontmatter:{}}),(F,L)=>{const e=r,u=i,o=m("RouterLink");return k(),d("div",h,[n("div",g,[w,f,s(e,{type:"info"},{default:t(()=>[y]),_:1}),v,s(e,{type:"important"},{default:t(()=>[b]),_:1}),x,s(e,{type:"info"},{default:t(()=>[_]),_:1}),z,s(u,{name:"creating-a-scene",folder:"guide"}),P]),C,n("div",R,[s(o,{to:"/guide/getting-started/installation",class:"prev"},{default:t(()=>[a("Installation")]),_:1}),s(o,{to:"/guide/getting-started/add-movement",class:"next"},{default:t(()=>[a("Add some movement")]),_:1})])])}}};typeof c=="function"&&c(j);export{j as default};
