import{b as e}from"./route-block-83d24a4e.js";import{o as n,c as o,b as r}from"./index-a7fac469.js";const t={class:"markdown-body"},l=r(`<h1>Fbo</h1><p>Fbo manage framebuffers creation</p><ul><li>support any kind of pixel formats (RGB, RGBA, LUMINANCE etc)</li><li>support any kind of pixel type (UNSIGNED_BYTE, FLOAT, half float, etc)</li><li>optional depth and/or stencil</li><li>resize</li><li>binding helpers</li></ul><p>##exemples</p><h5>Fbo creation</h5><p>Basic FBO</p><pre class="language-JavaScript"><code class="language-JavaScript">var Fbo = require( &#39;nanogl/fbo&#39; );
...
fbo.clear();
</code></pre>`,16),c=[l],i={__name:"fbo",setup(p,{expose:a}){return a({frontmatter:{}}),(d,f)=>(n(),o("div",t,c))}};typeof e=="function"&&e(i);export{i as default};
