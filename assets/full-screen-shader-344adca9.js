...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre>`,3),w=s('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#create-a-quad">Create a quad</a></li><li><a href="#create-the-program">Create the program</a><ul><li><a href="#vertex-shader">Vertex shader</a></li><li><a href="#fragment-shader">Fragment shader</a></li><li><a href="#program">Program</a></li></ul></li><li><a href="#draw-the-quad">Draw the quad</a></li><li><a href="#add-some-movement">Add some movement</a></li><li><a href="#optimization">Optimization</a></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div><div class="nav-wrapper"><a class="prev" href="/guide/getting-started/load-gltf">Load a GLTF model</a></div>',2),v={__name:"full-screen-shader",setup(y,{expose:o}){return o({frontmatter:{}}),(q,_)=>{const e=l,c=u;return r(),i("div",d,[n("div",m,[g,t(e,null,{default:k(()=>[h]),_:1}),f,t(c,{name:"full-screen-shader",folder:"guide"}),b]),w])}}};typeof a=="function"&&a(v);export{v as default};
