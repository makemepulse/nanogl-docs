import{A as c,P as d}from"./arraybuffer-1b6e50fc.js";import{useWebGL as m}from"./useWebGL-cc0b7991.js";const f=a=>{const{gl:e,size:t,start:i}=m(a),n=new Float32Array([-1,3,0,2,-1,-1,0,0,3,-1,2,0]),o=new c(e,n);o.attrib("aPosition",2,e.FLOAT),o.attrib("aTexCoord",2,e.FLOAT);const v=`
