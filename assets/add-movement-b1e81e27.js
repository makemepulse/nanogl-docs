...
<span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre>`,3),v=s('<div class="toc-wrapper"><p><div class="toc"><h2 class="my-8">Summary</h2><ul><li><a href="#setup-render-loop">Setup render loop</a></li><li><a href="#create-the-node">Create the node</a></li><li><a href="#play-transform">Play with the transform values</a><ul><li><a href="#setup-a-function">Setup a function</a></li><li><a href="#position-%26-scale">Position &amp; scale</a></li><li><a href="#rotation">Rotation</a></li><li><a href="#world-matrix">World matrix</a></li></ul></li><li><a href="#result">Result</a></li><li><a href="#final-code">Final code</a></li></ul></div></p></div><div class="nav-wrapper"><a class="prev" href="/guide/getting-started/creating-a-scene">Creating a scene</a><a class="next" href="/guide/getting-started/load-gltf">Load a GLTF model</a></div>',2),b={__name:"add-movement",setup(y,{expose:o}){return o({frontmatter:{}}),(j,_)=>{const e=l,c=u;return i(),k("div",m,[n("div",d,[g,p(e,{type:"important"},{default:r(()=>[f]),_:1}),h,p(c,{name:"add-movement",folder:"guide"}),w]),v])}}};typeof t=="function"&&t(b);export{b as default};
