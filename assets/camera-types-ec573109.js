import{C as S,P as U,O as D,N as j}from"./index-099e42fb.js";import{A as k,P as $}from"./arraybuffer-7f1df196.js";import{G as q,a as K,I as J}from"./indexbuffer-5b89fc58.js";import{P as Q}from"./tweakpane-24b35bd6.js";import{cubePosUvs as X,cubeIndices as Y}from"./cubeGeometry-a8671df7.js";import{c as Z}from"./vec3-33249e24.js";import{c as ee}from"./mat4-2d297a36.js";import"./common-a066d304.js";const le=O=>{let b=!0;const p=O||document.getElementById("canvas"),t=p.getContext("webgl"),o={width:1,height:1,canvasWidth:1,canvasHeight:1},C=window.devicePixelRatio,y=([e])=>{const n=e.contentRect.width,a=e.contentRect.height;p.width=Math.round(n*C),p.height=Math.round(a*C),o.width=t.drawingBufferWidth,o.height=t.drawingBufferHeight,o.canvasWidth=n,o.canvasHeight=a,f()},P=new ResizeObserver(y);P.observe(p);const h=q.get(t),H=new K().enableDepthTest().enableCullface().cullFace(t.BACK);h.push(H);const s={camera:"perspective",distance:20,perspective:{fov:35},ortho:{boundsScale:5}},g=Z(),i=new S(new U);i.lens.near=.01,i.lens.far=50,i.lookAt(g);const c=new S(new D);c.lens.near=.01,c.lens.far=50,c.lookAt(g);const z=()=>{i.lens.setAutoFov(s.perspective.fov*(Math.PI/180))},f=()=>{const e=Math.max(o.canvasHeight/o.canvasWidth,1),n=Math.max(o.canvasWidth/o.canvasHeight,1),a=s.ortho.boundsScale;c.lens.setBound(-a*n,a*n,-a*e,a*e)};f();let r=i;const w=new k(t,new Float32Array(X)),x=new J(t,t.UNSIGNED_SHORT,new Uint16Array(Y));w.attrib("aPosition",3,t.FLOAT),w.attrib("aTexCoord",2,t.FLOAT);const B=[],F=4,M=3,v=3,W=(F-1)*v*.5,_=(M-1)*v*.5;for(let e=0;e<F;e++)for(let n=0;n<M;n++){const a=new j;a.position.set([e*v-W,0,n*v-_]),a.invalidate(),a.updateWorldMatrix(),B.push(a)}const E=`
